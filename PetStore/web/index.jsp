            ...
            <div class="col-md-3 arr">
                <div class="bg">
                    ...
                    <div class="caption">
                        ...
                        <p><a href="getProduct?productId=CA-PS-01" class="btn btn-danger" role="button">More</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 arr">
                <div class="bg">
                    ...
                    <div class="caption">
                        ...
                        <p><a href="getProduct?productId=DG-GR-01" class="btn btn-danger" role="button">More</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 arr">
                <div class="bg">
                    ...
                    <div class="caption">
                        ...
                        <p><a href="getProduct?productId=BD-FC-03" class="btn btn-danger" role="button">More</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 arr">
                <div class="bg">
                    ...
                    <div class="caption">
                        ...
                        <p><a href="getProduct?productId=FI-GF-01" class="btn btn-danger" role="button">More</a></p>
                    </div>
                </div>
            </div>
            <div class="clearfix"></div>
